                      ...
                      ListTile(
                        ...
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => QuanLyDiemMonHocScreen(),
                            ),
                          );
                        },
                        ...
                        // Thêm hàng ngang chứa icon delete
                        trailing: Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () {
                                ...
                                _showDeleteStudentDialog(students[index]);
                              },
                            ),
                            IconButton(
                              ...
                              onPressed: () {
                                ...
                                _showEditStudentDialog(students[index]);
                              },
                            ),
                          ],
                        ),
  ...
  Future<void> _showDeleteStudentDialog(Student student) async {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Xóa'),
          content: Text('Bạn có chắc muốn xóa sinh viên ${student.hoVaTen}?'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
                Navigator.of(context).pop();
